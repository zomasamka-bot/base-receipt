...
export const DOMAIN_CONFIG = {
  ...
  productionUrl: 'https://base-receipt-vb-ch-f-g6-nqs-qc-d.vercel.app',
  fullDomain:  'base-receipt-vb-ch-f-g6-nqs-qc-d.vercel.app',
  description: 'Oversight and verification layer · No direct financial execution',

  getCurrentDomain: () => {
    if (typeof window === 'undefined') return 'base-receipt-vb-ch-f-g6-nqs-qc-d.vercel.app';
...
export class StateManager {
  ...
  private broadcastStateChange(): void {
    // Storage event fires in other tabs automatically when we call persistState()
  }
